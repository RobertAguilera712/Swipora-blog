Title: Parallel Structures With Coordinate Conjunctions
Date: 2026-09-13
Category: Advanced Grammar
Tags: Advance Grammar, TOEFL Preparation
Summary: Learn how to use parallel structure with coordinate conjunctions.

A parallel structure is just making the sentences parallel or "balanced" in both sides. Take a look to the following example:

<div class="grammar">
I like <span class='grammar-blue'>to read</span> <span class='grammar-purple'>and</span> <span class='grammar-red'>writing</span>.
</div>
<sub>
**\*<span class='grammar-blue'>Infinitive ("To" followed by a BASE VERB).</span>**<br>
**\*<span class='grammar-red'>Gerund (VERB ING).</span>**<br>
**\*<span class='grammar-purple'>Coordinate Conjunction.</span>**<br>
</sub>

In the previous example, we have a simple sentence that expresses our interests
using the verb **like**. As we know, this verb can be followed either by an
**<span class='grammar-blue'>infinitive</span>** or by a **<span class='grammar-red'>gerund</span>**. Therefore, the sentences: **"I like <span class='grammar-blue'>to read</span>"** and **"I like <span class='grammar-red'>writing</span>"**
are both correct as independent sentences, but **it is incorrect** to use an **<span class='grammar-blue'>Infinitive</span>** on one side and a **<span class='grammar-red'>Gerund</span>**  on the other.

When both sentences are joined using **<span class='grammar-purple'>"and,"</span>** we have to **"balance"** the sentence. Either we use 
**<span class='grammar-blue'>infinitives</span>** for both parts or we use **<span class='grammar-red'>gerunds</span>** for both. Fix the first wrong example as follows:

<div class="grammar">
I like <span class='grammar-blue'>to read</span> <span class='grammar-purple'>and</span> <span class='grammar-blue'>to write</span>.<br>
I like <span class='grammar-red'>reading</span> <span class='grammar-purple'>and</span> <span class='grammar-red'>writing</span>.
</div>
<sub>
**\*<span class='grammar-blue'>Infinitive ("To" followed by a BASE VERB).</span>**<br>
**\*<span class='grammar-red'>Gerund (VERB ING)</span>.**<br>
**\*<span class='grammar-purple'>Coordinate Conjunction.</span>**<br>
 ...
 The **coordinate conjunctions**, **<span class='grammar-purple'>"And,"</span>** **<span class='grammar-purple'>"But,"</span>** and 
**<span class="grammar-purple">"Or,"</span>** divide a sentence into two parts, and we must balance both parts when joining **adjectives, nouns, phrases, and clauses**. 
